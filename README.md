...
- **Subject-specific AI Tutors** – DSA, DBMS, AI/ML, etc., each with tailored prompts.
- **Interactive Q&A** – Ask natural language questions and get detailed, step-by-step answers.
...
- MySQL (Database)
- HTML and CSS (Frontend and Styling)
